...
public class TestRazionali3 {
    /* Si ammette che l'eccezione denominatore nullo sia una Exception ossia checked.
     * Le modifiche sono mostrate nella nuova classe RazionaleC.
